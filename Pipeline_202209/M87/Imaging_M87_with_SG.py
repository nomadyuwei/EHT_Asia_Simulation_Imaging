...
parser.add_argument('-i', '--infile',    default="simulated_M87_with_SG.uvfits", help="input UVFITS file")
parser.add_argument('-i2', '--infile2',  default="",          help="optional 2nd input file (different band) for imaging")
parser.add_argument('-o', '--outfile',   default='simulated_out_M87_with_SG.fits',  help='output FITS image')
parser.add_argument('--savepdf',         default='simulated_out_M87_with_SG.pdf',       help='saves image pdf (True or False)?',action='store_true')
parser.add_argument('--imgsum',          default='summary_M87_with_SG.pdf',       help='generate image summary pdf',action='store_true')
...
(error_1, im1_pad_1, im2_shift_1) = im.compare_images(im_out, metric='nrmse',
                                                                  ...
                                                                  target_fov=fov,
                                                                  blur_frac=0.0,
                                                                  beamparams=beamparams_M87_with_SG)
...
if args.savepdf:
    ...
    #im_out.display(label_type='scale', beamparams=beamparams_M87_with_SG, export_pdf=pdfout)
