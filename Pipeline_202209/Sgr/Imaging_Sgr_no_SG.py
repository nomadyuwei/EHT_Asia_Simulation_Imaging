...
parser.add_argument('-i', '--infile',    default="simulated_Sgr_no_SG.uvfits", help="input UVFITS file")
parser.add_argument('-i2', '--infile2',  default="",          help="optional 2nd input file (different band) for imaging")
parser.add_argument('-o', '--outfile',   default='simulated_out_Sgr_no_SG.fits',  help='output FITS image')
parser.add_argument('--savepdf',         default='simulated_out_Sgr_no_SG.pdf',       help='saves image pdf (True or False)?',action='store_true')
parser.add_argument('--imgsum',          default='summary_Sgr_no_SG.pdf',       help='generate image summary pdf',action='store_true')
...
if args.savepdf:
    ...
    #im_out.display(label_type='scale', beamparams=beamparams_no_SG, export_pdf=pdfout)
